...
public class RobotoCalendarView extends LinearLayout {
    ...
    public void markCircleImage(@NonNull Date date,int colorCode) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ImageView circleImage1 = getCircleImage1(calendar);
        ...
        if (lastSelectedDayCalendar != null && areInTheSameDay(calendar, lastSelectedDayCalendar)) {
            ...
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), colorCode));
        }
    }
    ...
    public void markCircleImage2(@NonNull Date date,int colorCalendar) {
        String colorStr = "#123456";
       // int colorV = Color.parseColor("#AE6118"); //The color u want
      //  circleImage2.getDrawable(), ContextCompat.getColor(getContext(), R.color.roboto_calendar_circle_2)
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ImageView circleImage2 = getCircleImage2(calendar);
        ...
        if (lastSelectedDayCalendar != null && areInTheSameDay(calendar, lastSelectedDayCalendar)) {
            ...
            DrawableCompat.setTint(circleImage2.getDrawable(), colorCalendar);
        }
    }
