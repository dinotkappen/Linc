...
public class SchoolCalander {
    ...
    public List<CalendarModel> getCalanderModel() {
        return calanderModel;
    }

    public void setCalanderModel(List<CalendarModel> calanderModel) {
        this.calanderModel = calanderModel;
    }

    @SerializedName("calanderModel")
    @Expose
    private List<CalendarModel> calanderModel = null;
